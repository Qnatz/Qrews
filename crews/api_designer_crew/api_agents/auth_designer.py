...
try:
    ...
    from crews.api_designer_crew.api_agents.models import AuthDefinition, EndpointList # CORRECTED Fallback
...
if __name__ == '__main__':
    ...
    if not os.environ.get("GEMINI_API_KEY"):
        ...
        try:
            from crews.api_designer_crew.api_agents.models import AuthDefinition as RealAuthDefinition # CORRECTED
        except: pass
