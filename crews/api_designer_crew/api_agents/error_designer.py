...
try:
    ...
    from crews.api_designer_crew.api_agents.models import ErrorSchemaDefinition # CORRECTED Fallback
...
if __name__ == '__main__':
    ...
    if not os.environ.get("GEMINI_API_KEY"):
        ...
        try:
            from crews.api_designer_crew.api_agents.models import ErrorSchemaDefinition as RealErrorSchemaDef # CORRECTED
        except: pass
